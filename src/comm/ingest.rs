...
const INGEST_VERSION_REQ: &str = ">=0.26.0-alpha.8,<0.26.0-alpha.9";
    ...
    match RawEventKind::try_from(u32::from_le_bytes(buf)).context("unknown raw event kind")? {
        ...
        RawEventKind::MalformedDns => {
            handle_data(
                ...
                sensor,
                db.malformed_dns_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::PeriodicTimeSeries => {
            handle_data(
                ...
                None,
                sensor,
                db.periodic_time_series_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::ProcessCreate => {
            handle_data(
                ...
                None,
                sensor,
                db.process_create_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::FileCreateTime => {
            handle_data(
                ...
                None,
                sensor,
                db.file_create_time_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::NetworkConnect => {
            handle_data(
                ...
                None,
                sensor,
                db.network_connect_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::ProcessTerminate => {
            handle_data(
                ...
                None,
                sensor,
                db.process_terminate_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::RegistryValueSet => {
            handle_data(
                ...
                None,
                sensor,
                db.registry_value_set_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::RegistryKeyRename => {
            handle_data(
                ...
                None,
                sensor,
                db.registry_key_rename_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::FileCreateStreamHash => {
            handle_data(
                ...
                None,
                sensor,
                db.file_create_stream_hash_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::ProcessTamper => {
            handle_data(
                ...
                None,
                sensor,
                db.process_tamper_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
        ...
        RawEventKind::FileDeleteDetected => {
            handle_data(
                ...
                None,
                sensor,
                db.file_delete_detected_store_writable()?,
                stream_direct_channels,
                shutdown_signal,
                ack_trans_cnt,
            )
...
async fn handle_data<T>(
    ...
    sensor: String,
    store: WritableRawEventStoreHandle<'_, T>,
    stream_direct_channels: StreamDirectChannels,
    shutdown_signal: Arc<AtomicBool>,
    ack_trans_cnt: u16,
) -> Result<()> {
