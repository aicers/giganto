...
use crate::storage::DatabaseMode;
...
use crate::{
    ...
    storage::{
        ...
        Tls as TlsFromV21, WritableRawEventStore, rocksdb_options,
    },
};
...
fn migrate_0_13_to_0_19_0(db_path: &Path, db_opts: &DbOptions) -> Result<()> {
    ...
    let netflow5_store: WritableRawEventStore<'_, Netflow5FromV23> = db.netflow5_store()?;
...
fn migrate_netflow_from_0_13_to_0_19_0<S, T>(store: &dyn WritableRawEventStore<'_, S>) -> Result<()>
where
