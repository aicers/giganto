...
fn migrate_0_24_to_0_26_conn(db: &Database) -> Result<()> {
    ...
    for raw_event in store.iter_forward() {
        ...
        let new_conn = ConnFromV26 {
            ...
            start_time: chrono::Utc.timestamp_nanos(session_start_time),
            end_time: chrono::Utc.timestamp_nanos(end_time),
...
fn migrate_0_24_to_0_26_http(db: &Database) -> Result<()> {
    ...
    for raw_event in store.iter_forward() {
        ...
        let new_http = HttpFromV26 {
            ...
            resp_port: old.resp_port,
            proto: old.proto,
            start_time: chrono::Utc.timestamp_nanos(start_time),
            end_time: chrono::Utc.timestamp_nanos(old.end_time),
...
mod tests {
    ...
    fn migrate_0_24_to_0_26_0_raw_event() {
        ...
        let new_conn = ConnFromV26 {
            ...
            proto: 6,
            conn_state: String::new(),
            start_time: Utc.timestamp_nanos(timestamp.try_into().unwrap()),
            end_time: Utc.timestamp_nanos((timestamp + 100).try_into().unwrap()),
            duration: 100,
            service: "-".to_string(),
            orig_bytes: 77,
            resp_bytes: 295,
        ...
        let new_http = HttpFromV26 {
            ...
            start_time: Utc.timestamp_nanos(timestamp.try_into().unwrap()),
            end_time: Utc.timestamp_nanos(old_http.end_time),
            duration: old_http.end_time - timestamp.try_into().unwrap_or(i64::MAX),
            orig_pkts: 0,
            resp_pkts: 0,
            orig_l2_bytes: 0,
            resp_l2_bytes: 0,
        ...
        let new_dns = DnsFromV26 {
            ...
            proto: dns_old.proto,
            start_time: Utc.timestamp_nanos(timestamp.try_into().unwrap()),
            end_time: Utc.timestamp_nanos(dns_old.end_time),
            duration: dns_old.end_time - timestamp.try_into().unwrap_or(i64::MAX),
            orig_pkts: 0,
            resp_pkts: 0,
            orig_l2_bytes: 0,
            resp_l2_bytes: 0,
        ...
        let new_rdp = RdpFromV26 {
            ...
            proto: rdp_old.proto,
            start_time: Utc.timestamp_nanos(timestamp.try_into().unwrap()),
            end_time: Utc.timestamp_nanos(rdp_old.end_time),
            duration: rdp_old.end_time - timestamp.try_into().unwrap_or(i64::MAX),
            orig_pkts: 0,
            resp_pkts: 0,
            orig_l2_bytes: 0,
            resp_l2_bytes: 0,
        ...
        let new_smtp = SmtpFromV26 {
            ...
            start_time: Utc.timestamp_nanos(timestamp.try_into().unwrap()),
            end_time: Utc.timestamp_nanos(smtp_old.end_time),
            duration: smtp_old.end_time - timestamp.try_into().unwrap_or(i64::MAX),
            orig_pkts: 0,
            resp_pkts: 0,
            orig_l2_bytes: 0,
            resp_l2_bytes: 0,
        ...
        let new_ntlm = NtlmFromV26 {
            ...
            proto: 17,
            start_time: Utc.timestamp_nanos(timestamp.try_into().unwrap()),
            end_time: Utc.timestamp_nanos(1),
            duration: (1_i64).saturating_sub(timestamp.try_into().unwrap_or(i64::MAX)),
            orig_pkts: 0,
            resp_pkts: 0,
            orig_l2_bytes: 0,
            resp_l2_bytes: 0,
