        ...
        impl JsonOutput<$to> for $from {
            fn convert_json_output(&self, time:String, sensor:String) -> Result<$to> {
                Ok($to {
                    ...
                    proto: self.proto,
                    start_time: self.start_time.timestamp_nanos_opt().unwrap_or(0),
                    end_time: self.end_time.timestamp_nanos_opt().unwrap_or(0),
...
impl JsonOutput<FileCreateTimeJsonOutput> for FileCreationTimeChanged {
    fn convert_json_output(
        ...
        Ok(FileCreateTimeJsonOutput {
            ...
            creation_utc_time: self.creation_utc_time.timestamp_nanos_opt().unwrap_or(0),
            previous_creation_utc_time: self
