...
mod tests {
    ...
    async fn run_local_error_query(query: &str, expected_error: &str) {
        let schema = TestSchema::new();
        let res = schema.execute(query).await;
    ...
    fn normalize_error_query(query: &str) -> String {
        query.replace("sensor: \"src 2\"", "sensor: \"src 1\"")
    }

    fn replace_first_pagination(query: &str, replacement: &str) -> String {
    ...
    fn make_same_cursor_query(query: &str) -> String {
        let cursor = "Y3Vyc29y";
    ...
    fn make_after_last_query(query: &str) -> String {
        replace_first_pagination(query, "after: \"Y3Vyc29y\", last: 1")
    }

    fn make_before_first_query(query: &str) -> String {
        replace_first_pagination(query, "before: \"Y3Vyc29y\", first: 1")
    }

    fn make_out_of_range_after_query(query: &str) -> String {
        replace_first_pagination(query, "after: \"AA==\", first: 1")
    }

    fn make_out_of_range_before_query(query: &str) -> String {
