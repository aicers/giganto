...
mod tests {
    ...
    use super::{
        ...
        peer_in_charge_graphql_addr, request_peer, sort_and_trunk_edges,
    };
    use crate::comm::{
        IngestSensors,
        peer::{PeerInfo, Peers},
    ...
    fn test_sort_and_trunk_edges_secondary_order() {
        ...
        let result = sort_and_trunk_edges(make_edges(), None, None, None);
        ...
        let result_first = sort_and_trunk_edges(make_edges(), None, Some(2), None);
        ...
        let result_last = sort_and_trunk_edges(make_edges(), Some("any"), None, Some(2));
